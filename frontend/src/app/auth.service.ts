...
export class AuthService {
  ...
  refreshToken(): Observable<AuthResponse> {
    ...
    return this.http.post<AuthResponse>(`${this.baseUrl}token/refresh/`, { refresh: refreshToken }).pipe(
      tap(response => this.cookieService.set('access_token', response.access, { path: '/' })),
      catchError(error => {
        this.logout();
